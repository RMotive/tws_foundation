  ...
  LocationsEntityTableEntry({
    super.key,
         ...
         description: (LandingThemeB theme, Color foreColor) {
           return TextSpan(
             text:
                 'Foundation {CSM} Entity Table representing [Location] entity data and interactions, handles foundation possible interactions related with [Employee] data management, like details drawer viewer, inline entity edition, entity remotion, etc.',
             style: TextStyle(
               color: foreColor,
             ),
           );
