...
/// {entry} class.
///
/// Implements a [PackageLandingEntryBase] for [ProfilesPage] from {tws_foundation_view} package as part of the package landing playground.
final class ProfilesCategoryPageEntry extends PackageLandingEntryBase<LandingThemeB> {
  late final ICategoryLayoutPage categoryPage;

  /// Creates a new [ProfilesCategoryPageEntry] instance.
  ProfilesCategoryPageEntry({
    super.key,
         ...
         description: (LandingThemeB theme, Color foreColor) {
           return TextSpan(
             text:
                 'A Profiles Category page provides visual interaction with the business entity management operations',
             style: TextStyle(
               color: foreColor,
             ),
           );
    ...
    categoryPage = ProfilesCategoryPage();
  }
  ...
  Widget composeEntry(BuildContext buildContext, Size windowSize, LandingThemeB theme) {
    RoutingData routeData = RoutingData(
      ...
      absolutePath: '/profiles_category_page',
    );
