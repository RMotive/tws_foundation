...
using View = CSM_Foundation.Database.Models.Out.SetViewOut<TWS_Business.Entities.Trucks.TruckEntry>;

namespace TWS_Foundation.Quality.Suit.Controllers.Business;
public class Q_TrucksInventories
    : BQ_CustomServerController {
    public Q_TrucksInventories(WebApplicationFactory<Program> hostFactory)
        : base("TrucksInventories", hostFactory) {
    }
