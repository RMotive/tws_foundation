...
/// </summary>
public class IdentificationsDepot : BDepot<BusinessDatabase, Identification> {
    /// <summary>
    ///     Generates a new depot handler for <see cref="Axis"/>.
    /// </summary>
    public IdentificationsDepot(BusinessDatabase Databases, IDisposer? Disposer = null)
