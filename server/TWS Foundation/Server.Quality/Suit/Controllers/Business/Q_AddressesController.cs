...
using View = CSM_Foundation.Database.Models.Out.SetViewOut<TWS_Business.Sets.Address>;

namespace TWS_Foundation.Quality.Suit.Controllers.Business;
public class Q_AddressesController
    : BQ_CustomServerController<Employee> {

    public Q_AddressesController(WebApplicationFactory<Program> hostFactory)
        : base("Addresses", hostFactory) {
    }
