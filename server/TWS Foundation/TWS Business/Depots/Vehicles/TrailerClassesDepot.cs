...
/// </summary>
public class TrailerClassesDepot
    : BDepot<Database, Trailer_Class>, ITrailerClassesDepot {

    /// <summary>
    ///     Generates a new depot handler for <see cref="Location"/>.
    /// </summary>
    public TrailerClassesDepot(Database Databases, IDisposer? Disposer = null) : base(Databases, Disposer) { }
}
