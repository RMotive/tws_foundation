...
abstract interface class ContactsServiceI extends FoundationServiceB implements IService, IViewService<Contact, FoundationResponseResolver<ViewOutput<Contact>>>, ICreateService<Contact, FoundationResponseResolver<BatchOperationOutput<Contact>>> {
