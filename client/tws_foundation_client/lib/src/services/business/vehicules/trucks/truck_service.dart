...
abstract interface class TrucksServiceI extends FoundationServiceB implements IService, IViewService<TruckCommon, ResponseResolverBase<ViewOutput<TruckCommon>>>, CreateServiceI<TruckCommon> {
