...
abstract interface class LocationsServiceI extends FoundationServiceB implements IService, IViewService<Location, ResponseResolverBase<ViewOutput<Location>>>, CreateServiceI<Location> {
