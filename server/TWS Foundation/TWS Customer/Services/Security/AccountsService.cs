...
public class AccountsService
    ...
    public AccountsService(IAccountsDepot AccountsDepot, TWSSecurityDatabase Database, IDisposer? Disposer) {
        this.Database = Database;
        this.Disposer = Disposer;
        this.AccountsDepot = AccountsDepot;
    }
    ...
    public async Task<SetViewOut<Permit>> GetPermits(Account Account) {
        return new SetViewOut<Permit>() {
            ...
            Count = 0,
            Length = 0,
            Records = await AccountsDepot.GetPermits(Account.Id),
        };
    }
    ...
    public async Task<SetBatchOut<Account>> Create(Account[] accounts) {
        ...
        return await AccountsDepot.Create(accounts);
    }
    ...
    public async Task<RecordUpdateOut<Account>> Update(Account Account) {
        ...
        if (current == null) {
            return await AccountsDepot.Update(Account, Include);
        }
    ...
    public async Task<Account> Delete(Account Account) {
        ...
        return await AccountsDepot.Delete(Account);
    }
