...
- Notes:
    ...
    15. Now the test folder has changed the way to run and define tests:
    ...
    16. Now the [src] folder, the main library content for the package, nesting has changed for a Feature based folder management, now we will be able to see inside the [services] folder the [security] and [business] that work as a category folders and inside them
