...
void main() {
  ...
  test(
    ...
    () async {
      ...
      MainResolver<SetViewOut<Profile>> fact = await service.view(
        SetViewOptions<Profile>(false, 10, 1, null, <SetViewOrderOptions>[], <SetViewFilterNodeInterface<Profile>>[]),
        auth,
      );
      fact.resolve(
