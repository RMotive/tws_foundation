  ...
  DataMap encode([DataMap? entityObject]) {
    ...
    return super.encode(
      <String, Object?>{
        ...
        kLicenseExpiration: licenseExpiration?.dateOnly,
        kDrugalcRegistrationDate: drugAlcRegistrationDate?.dateOnly,
        kPullnoticeRegistrationDate: pullNoticeRegistrationDate?.dateOnly,
        kTwicExpiration: twicExpiration?.dateOnly,
        kVisaExpiration: visaExpiration?.dateOnly,
        kFastExpiration: fastExpiration?.dateOnly,
        kAnamExpiration: anamExpiration?.dateOnly,
