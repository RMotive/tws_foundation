            ...
            children: <Widget>[
              ...
              TextInput(
                ...
                onChanged: (String value){
                  VehiculeModel? model =  itemState?.entity.internal?.model;
                  model = model != null ? model.sanitize(name: value) : VehiculeModel().sanitize(name: value);
              ...
              TextInput(
                ...
                onChanged: (String value) {
                  VehiculeModel? model =  itemState?.entity.internal?.model;
                  model =
                      model != null ? model.sanitize(description: value) : VehiculeModel().sanitize(description: value);
                  model?.status = _defaultStatus;
                  itemState?.react();
                } 
              ),
