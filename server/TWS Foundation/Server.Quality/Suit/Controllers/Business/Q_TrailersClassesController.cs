...
using View = CSM_Foundation.Database.Models.Out.SetViewOut<TWS_Business.Sets.TrailerClass>;
...
public class Q_TrailersClassesController : BQ_CustomServerController<TrailerClass> {
    ...
    public Q_TrailersClassesController(WebApplicationFactory<Program> hostFactory)
        : base("TrailersClasses", hostFactory) {
    }
