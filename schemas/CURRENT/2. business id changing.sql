...
BEGIN
    ...
    -- Step 2: Drop foreign key constraints that reference these Id columns
    ...
    -- Step 4: Alter Id column type
    SET @sql = @sql + N'ALTER TABLE ' + QUOTENAME(@table) +
               N' ALTER COLUMN ' + QUOTENAME(@column) + N' BIGINT;' + CHAR(13);

    -- Step 5: Alter referencing columns to match the new data type
    ...
    -- Step 7: Recreate foreign key constraints with the specified naming convention
