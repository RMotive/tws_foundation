...
abstract interface class YardLogsServiceI extends FoundationServiceB implements IService, IViewService<YardLog, FoundationResponseResolver<ViewOutput<YardLog>>>, ICreateService<YardLog, FoundationResponseResolver<BatchOperationOutput<YardLog>>>, ExportServiceI<YardLog> {
