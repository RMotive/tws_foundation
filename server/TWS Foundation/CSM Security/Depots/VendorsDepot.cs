...
/// <summary>
///     [Interface] for [VendorsDepot] implementations.
/// </summary>
...
public class VendorsDepot
    : DepotBase<Database, Vendor>, IVendorsDepot {
    /// <summary>
    ///     Generates a new depot handler for <see cref="Solution"/>.
    /// </summary>
    public VendorsDepot(Database Databases, IDisposer<IEntity>? Disposer = null)
