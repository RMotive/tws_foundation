...
public class YardLogsService
    ...
    /// </param>
    private static void CommonConfigurator(int situation, Object? common, int? locationID) {
        if (common != null) {
    ...
    private static void SetCommonNavigators(YardLog newYardlog) {
        // Check the log type.
        if (newYardlog.Entry) {
