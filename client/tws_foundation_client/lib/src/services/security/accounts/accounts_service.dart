...
abstract interface class AccountServiceI extends FoundationServiceB implements IService, IViewService<Account, FoundationResponseResolver<ViewOutput<Account>>>, ICreateService<Account, FoundationResponseResolver<BatchOperationOutput<Account>>> {
