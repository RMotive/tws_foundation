...
abstract interface class FeaturesServiceI extends FoundationServiceB implements IService, IViewService<Feature, FoundationResponseResolver<ViewOutput<Feature>>>, ICreateService<Feature, FoundationResponseResolver<BatchOperationOutput<Feature>>> {
